#!/usr/bin/env python3
"""
Batch OEM ID Update Script for Store 7619 (MB Cutler Bay)
Processes all 154 users from oemexcel_7619.csv
"""
...
# File paths
CSV_FILE = "/Users/tlreddy/Documents/project-1-child/oemexcel_7619.csv"
RESULTS_FILE = "/Users/tlreddy/Documents/project-1-child/oemexcel_7619_results.csv"

def fetch_all_users():
    """Fetch all users from Tekion with pagination"""
    print("="*80)
...
def main():
    ...
    print("\n" + "🚀"*40)
    print("BATCH OEM ID UPDATE - STORE 7619 (MB CUTLER BAY)")
    ...
    success_count = sum(1 for row in oem_data if row['status'] == 'Done')
    failed_count = len(oem_data) - success_count
